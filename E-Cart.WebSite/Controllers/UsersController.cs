...
namespace E_Cart.WebSite.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(ECartDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,UserName,MobileNumber,Address,Email,Password")] Users users)
        {
            if (id != users.UserId)
            {
                return NotFound();
